var PokemonRoleRules = globalThis.PokemonRoleRules || (() => {
    ...
    return Object.freeze({ SCHEMA_VERSION, ROLE_RULES_VERSION, STATS, ROLES, RATING_BANDS, NATURE_ADJUSTMENTS, ABILITY_TAGS, SPECIAL_CASES, role, ratingFor, abilityTags });
})();
