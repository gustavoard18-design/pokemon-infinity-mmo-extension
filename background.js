    ...
    chrome.scripting
        ...
        .then(() => {
            chrome.scripting.executeScript({
                target: { tabId },
                files: ['data/extension-storage.js', 'components/theme.js', 'components/panel-position.js', 'components/pixel-icon.js', 'components/panel-zoom.js', 'components/tooltip.js', 'components/header-buttons.js', 'components/shortcut-utils.js', 'components/settings-panel.js', 'content.js']
            });
