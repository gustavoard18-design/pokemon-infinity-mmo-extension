...
| `pokemon-evaluation.js` | Avaliação pura do exemplar conforme o perfil funcional da espécie; produz Função, nota, confiança e adequações |
...
| `pokemon-role-rules.js` | Taxonomia versionada de funções, pesos de IV, faixas, tags de habilidades e exceções |
| `pokemon-species-profiler.js` | Gera o perfil funcional fixo de cada espécie durante a atualização da Pokédex |
